      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-sm">Nozzle {nozzleNumber}</span>
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          <div className="text-center p-2 bg-white rounded border">
            ...
            <div className="font-bold text-primary">{safeToFixed(enteredReading, 2)}</div>
          </div>
          <div className="flex items-center justify-center text-muted-foreground">−</div>
          <div className="text-center p-2 bg-white rounded border">
            <div className="text-muted-foreground">Last</div>
            <div className="font-bold text-primary">{safeToFixed(lastReading, 2)}</div>
          </div>
        </div>
