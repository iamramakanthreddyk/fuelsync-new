...
export const FuelPriceCard: React.FC<FuelPriceCardProps> = ({
  ...
  if (isLoading) {
    return (
      <div className="w-full sm:w-auto min-w-0 flex items-center gap-2 px-3 py-2 bg-muted/30 rounded-lg border animate-pulse">
    ...
    if (showWarning && canSetPrices) {
      return (
        <div
          ...
          className="w-full sm:w-auto min-w-0 flex items-center gap-2 px-3 py-2 bg-red-50 rounded-lg border border-red-200 cursor-pointer hover:bg-red-100 transition-colors"
        >
